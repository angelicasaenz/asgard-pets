...
* **Arquitectura:** Separación por capas (`model`, `service`, `util`, `view`).
...
Este proyecto tiene un propósito estrictamente educativo. Cada nueva versión refleja y valida las competencias adquiridas en nuestra ruta de aprendizaje en desarrollo backend.

Desarrollado con ❤️ mientras aprendemos Java.